...
# Submit your PR on this new repo for the Hacktoberfest-2022.

**This is a beginner-friendly project to help you get started with your
[hacktoberfest](https://hacktoberfest.digitalocean.com/). This is AI/ML repo based on spaceship-Titanic, it is created to help new aspiring AI/ML enginers, data Scientists to find a community and show case there skills in a AI/ML project through colabration. If you don't know where to start, feel free to watch the videos linked below, and read the contribution rules. Happy Learning <3 💙 !!**
...
```terminal
git clone https://github.com/Swaijit-Singh/AI-ML-hacktoberfest.git
```
- Navigate to project directory.
```terminal
cd AI-ML-hacktoberfest
```
...
```terminal
git remote add upstream https://github.com/Swaijit-Singh/AI-ML-hacktoberfest.git
```
